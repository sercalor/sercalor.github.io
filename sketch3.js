...
let c1text = 'Flamboyan'; 
let c1stext = 'British Columbia, Canada';
...
// //Setup
  sketch.setup = function() {
    ...
    canvas1.position(0,790); //position over the screen
...
let iframeheighttall = 800;
////////////////////////



iframe1 = sketch.createElement("iframe");
iframe1.attribute("src","iframes/flamboyan.html");
...
iframe1.position(iframeleftall,iframeheighttall);
iframe1.hide();
...
iframe2.position(iframeleftall,iframeheighttall );
iframe2.hide();
...
iframe3.position(iframeleftall,iframeheighttall );
iframe3.hide();
